// To parse this data:
//
//   import { Convert, SongServiceDTO } from "./file";
//
//   const songServiceDTO = Convert.toSongServiceDTO(json);
//
...
export class Convert {
    public static toSongServiceDTO(json: string): SongServiceDTO {
        return cast(JSON.parse(json), r("SongServiceDTO"));
    }

    public static songServiceDTOToJson(value: SongServiceDTO): string {
        return JSON.stringify(uncast(value, r("SongServiceDTO")), null, 2);
    }
}
...
const typeMap: any = {
    ...
    "CreateSongRequest": o([
        ...
        { json: "title_token", js: "title_token", typ: a("") },
        { json: "categories", js: "categories", typ: a("") },
        { json: "artist_ids", js: "artist_ids", typ: u(undefined, a(0)) },
        { json: "artists", js: "artists", typ: u(undefined, a("")) },
    ], false),
